...
<div class="col-md-4">
		...
		<div class="controls">
			...
			<fieldset>
				<input type="checkbox" id="checkbox_4" name="service" value="1">
...
<div class="col-md-4">
		...
		<div class="controls">
			...
			<fieldset>
				<input type="checkbox" id="checkbox_10" name="complainbooking" value="1">
...
<div class="col-md-4">
	<div class="form-group">
		...
		<div class="controls">
			<fieldset>
				<input type="checkbox" id="checkbox_12" name="bookings" value="1">

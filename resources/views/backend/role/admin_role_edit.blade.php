...
<div class="col-md-4">
		...
		<div class="controls">
			<fieldset>
				...
				<label for="checkbox_2">Agency</label>
			</fieldset>
			<fieldset>
			...
			<fieldset>
				<input type="checkbox" id="checkbox_4" name="service" value="1" {{ $adminuser->product == 1 ? 'checked' : '' }}>
				<label for="checkbox_4">Service</label>
			</fieldset>
...
<div class="col-md-4">
		...
		<div class="controls">
			...
			<fieldset>
				<input type="checkbox" id="checkbox_10" name="complainbooking" value="1" {{ $adminuser->complainbooking == 1 ? 'checked' : '' }}>
				<label for="checkbox_10">Booking Complain</label>
			</fieldset>
...
<div class="col-md-4">
	<div class="form-group">
		...
		<div class="controls">
			<fieldset>
				<input type="checkbox" id="checkbox_12" name="bookings" value="1" {{ $adminuser->bookings == 1 ? 'checked' : '' }}>
				<label for="checkbox_12">Bookings</label>
			</fieldset>
			<fieldset>

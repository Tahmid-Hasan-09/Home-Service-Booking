...
<a href="{{ route('add.admin') }}" class="btn btn-danger" style="float: right;">Add Admin User</a>
	 ...
	 <tr>
		...
		<td>
			@if($item->brand == 1)
			<span class="badge btn-primary">Agency</span>
			@else
			@endif
			...
			@if($item->service == 1)
			<span class="badge btn-success">Service</span>
			@else
			@endif
			...
			@if($item->complainbooking == 1)
			<span class="badge btn-primary">Booking Complain</span>
			@else
			@endif
			...
			@if($item->bookings == 1)
			<span class="badge btn-success">Bookings</span>
			@else
			@endif

			...
			<div class="col-8">
			 ...
			 <div class="box">
				<div class="box-header with-border">
				  <h3 class="box-title">Agency List <span class="badge badge-pill badge-danger"> {{ count($brands) }} </span></h3>
				</div>
				<!-- /.box-header -->
				<div class="box-body">
...
<!--   ------------ Add Brand Page -------- -->
 ...
 <form method="post" action="{{ route('brand.store') }}" enctype="multipart/form-data">
	 ...
	 <div class="form-group">
		<h5>Agency Name English  <span class="text-danger">*</span></h5>
		<div class="controls">
	...
	<div class="form-group">
		<h5>Agency Name Bangla <span class="text-danger">*</span></h5>
		<div class="controls">
	...
	<div class="form-group">
		<h5>Agency Image <span class="text-danger">*</span></h5>
		<div class="controls">
